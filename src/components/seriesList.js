        ...
        <div className="serieslist">
            ...
            {!series.error && series.list.length !== 0 && (
                ...
                {series.list.map((seri) => (
                    <div className="series-item" key={seri.slug}>
                        <div className="series-content">
                            ...
                            <div className="series-preview">
                                ...
                                <ul>
                                    {seri.chapters.map((chapter) => (
                                        <li><Link to={chapter.c_slug}>Chapter {chapter.c_ch}</Link>{chapter.c_date && <span className="date">{chapter.c_date}</span>}{chapter.status && <span className="date">{chapter.status}</span>}{!chapter.c_date && !chapter.status && <span className="date-new">New</span>}</li>
                                    ))}
                                </ul>
                            </div>
                        </div>
